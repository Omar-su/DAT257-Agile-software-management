package com.example.eurythmics.model.api.database;
...
/**
 * Provides the com.example.eurythmics.model.api.database required for storing movie, rating and category information,
 * as well as handling the com.example.eurythmics.model.api.database's inserting, removing, and requesting data.
 */
public class DataBaseManager extends SQLiteOpenHelper{
    ...
    /**
     * Generates a com.example.eurythmics.model.api.database for storing the created tables
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldV, int newV) {
        System.out.println("Updated the com.example.eurythmics.model.api.database");
        if(oldV != newV){
